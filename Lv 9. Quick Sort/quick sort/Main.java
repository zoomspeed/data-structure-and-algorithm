...
public class Main {
	...
	public static void quickSort(int start, int end) {
		...
		left_cnt = getLeft(start + 1, end, pivot, left);
		right_cnt = getRight(start + 1, end, pivot, right);
		// System.out.println(left_cnt);
	...
	public static int getLeft(int start, int end, int pivot, int[] left) {
	...
	public static int getRight(int start, int end, int pivot, int[] right) {
